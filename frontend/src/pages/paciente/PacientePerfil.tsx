...
// Input de contraseña con botón de visibilidad integrado
const PassInput = ({
      ...
      {tab === 'perfil' && perfil && (
        <div style={{
          ...
          <div style={{ padding: '8px 24px 20px' }}>
            ...
            <DataRow label="Fecha de nacimiento" value={formatFecha(perfil.fecha_nac)} />
            <DataRow label="Edad"               value={perfil.edad ? `${perfil.edad} años` : '—'} />
            <DataRow label="Dirección"          value={perfil.direccion || '—'} />
            <DataRow label="CI"                 value={perfil.ci || '—'} />
            <DataRow
              label="Estado"
              value={
                <span style={{
